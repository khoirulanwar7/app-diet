      ...
      <div class="h-full w-full mx-5 flex flex-wrap justify-center">
        ...
        <div class="w-full md:w-1/2 lg:w-1/4 mx-4">
          <form action="" class="">
            ...
            <div class="mt-8">
              <button type="submit"
                class="py-1.5 w-full shadow-md bg-blue-900 hover:bg-blue-800 hover:shadow-xl rounded-lg text-white font-semibold">
                SIGN UP
              </button>
            </div>
          </form>
          <div class="flex justify-between mt-9 px-2">
            <p class="mx-auto text-slate-800">Already your an account? <a href="/login" class="text-blue-800 hover:underline">Sign In</a></p>
          </div>
        </div>
      </div>
    </div>
